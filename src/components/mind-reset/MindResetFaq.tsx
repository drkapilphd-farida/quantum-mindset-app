...
export default function MindResetFaq(): React.JSX.Element {
  const { t } = useLanguage();
  const section = t.mindResetLanding.faq;

  return (
    <section id="faq" className="border-b border-line px-6 py-20 sm:px-8">
      <div className="mx-auto max-w-content">
        ...
        <div className="mx-auto mt-10 flex max-w-3xl justify-center">
          <a
            ...
            onClick={() => trackGaEvent("whatsapp_click", { location: "mind_reset_faq" })}
